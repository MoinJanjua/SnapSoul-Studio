        ...
        @objc func starButtonTapped(_ sender: UIButton) {
         ...
         func submitButtonTapped() {
            guard selectedRating > 0, !feedbackTextView.text.isEmpty else {
                ...
                let alert = UIAlertController(title: "Alert!", message: "Your feedback and rating would be greatly appreciated.", preferredStyle: .alert)
                alert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
                present(alert, animated: true, completion: nil)
                return
            }
            
            let confirmationAlert = UIAlertController(title: "Successful!", message: "Thank you for your valuable feedback.!", preferredStyle: .alert)
